...
const addDictionaryLinks = items => (text) => {
...
const domAddDictionaryLinks = items => (dom) => {
  const body = dom.window.document.querySelector('body');
  applyHTMLToTextNodes(body)(addDictionaryLinks(items));
}
...
// build
const buildDictionary = (items, files, templates) => {
...
module.exports = { domAddDictionaryLinks, mapDirectoryItems, buildDictionary }
